...
![](img/regresion/diagrama_dispersion.svg" alt="Diagrama de dispersión" width="300">
...
![](img/regresion/diagrama_dispersion_estatura_peso.svg" alt="Diagrama de dispersión de estaturas y pesos" width="600">

:::{.callout-tip}
El diagrama de dispersión da información visual sobre el tipo de relación entre las variables.

![](img/regresion/diagrama_dispersion_tipos_relaciones.svg" alt="Diagramas de dispersión de diferentes tipos de relaciones" width="700">
:::
...
![](img/regresion/desviaciones_media.svg" alt="Desviaciones de las medias en un diagrama de dispersión" width="600">
...
![](img/regresion/cuadrantes_diagrama_dispersion.svg" alt="Cuadrantes de un diagrama de dispersión" width="400">
...
![](img/regresion/diagrama_dispersion_lineal_creciente.svg" alt="Diagrama de dispersión de una relación lineal creciente" width="500">
...
![](img/regresion/diagrama_dispersion_lineal_decreciente.svg" alt="Diagrama de dispersión de una relación lineal decreciente" width="500">
...
![](img/regresion/residuos_y.svg" alt="Residuos de un modelo de regresión" width="600">
...
:::{#def-}
## Recta de regresión
Dada una variable bidimensional $(X,Y)$, la _recta de regresión_ de $Y$ sobre $X$ es
...
:::{#exm-}
Utilizando la muestra anterior de estaturas ($X$) y pesos ($Y$) con los siguientes estadísticos
...
![](img/regresion/rectas_regresion.svg" alt="Rectas de regresión de estaturas y pesos" width="600">
...
![](img/regresion/regresion_lineal_perfecta.svg" alt="Recta de regresión de una relación lineal perfecta" width="500">
...
![](img/regresion/rectas_independencia_lineal.svg" alt="Rectas de regresión de dos variables linealmente independientes" width="500">
...
:::{#exm-}
En el ejemplo de las estaturas y los pesos, la recta de regresión del
...
:::{#exm-}
En la muestra de las estaturas y los pesos, si se quiere predecir
...
![](img/regresion/variation_decomposition.gif" alt="Descomposición de la variabilidad de un modelo de regresión" width="600">
...
![](img/regresion/grados_correlacion.svg" alt="Modelos de regresión lineales con diferentes grados de correlación" width="700">
...
![](img/regresion/evolucion_bacterias.svg" alt="Diagrama de dispersión de la evolución de bacterias" width="500">
...
![](img/regresion/regresion_lineal_bacterias.svg" alt="Regresión lineal de la evolución de un cultivo de bacterias" width="500">
...
![](img/regresion/evolucion_log_bacterias.svg" alt="Diagrama de dispersión de la evolución del logarítmo de las bacterias de un cultivo" width="500">
...
![](img/regresion/regresion_exponencial_bacterias.svg" alt="Regresión exponencial de la evolución de las bacterias de un cultivo" width="500">
...
![](img/regresion/regresion_lineal_relacion_cuadratica.svg" alt="Modelo de regresión lineal en una relación cuadrática" width="500">
![](img/regresion/regresion_cuadratica.svg" alt="Modelo de regresión cuadrático en una relación cuadrática" width="500">
...
![](img/regresion/diagrama_dispersion_con_datos_atipicos.svg" alt="Diagrama de dispersión con un dato atípico" width="500">
...
<div class="center">
![](img/regresion/regresion_lineal_con_datos_atipicos.svg" alt="Modelo de regresión lineal con datos atípicos" width="500"> ![](img/regresion/regresion_lineal_sin_datos_atipicos.svg" alt="Modelo de regresión lineal sin datos atípicos" width="500">
</div>
...
<div class="center">
![](img/regresion/paradoja_simpson_1.svg" alt="Paradoja de Simpson. Relación inversa entre las horas de estudio para un examen y la nota obtenida." width="500">
</div>
...
<div class="center">
![](img/regresion/paradoja_simpson_2.svg" alt="Paradoja de Simpson. Relación directa entre las horas de estudio para un examen y la nota obtenida." width="500">
</div>