...
\end{tabular}
\end{flushleft}
\end{titlepage}\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[interior hidden, breakable, enhanced, frame hidden, sharp corners, borderline west={3pt}{0pt}{shadecolor}, boxrule=0pt]}{\end{tcolorbox}}\fi
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Interpretación}, opacitybacktitle=0.6, breakable, bottomtitle=1mm, toptitle=1mm, leftrule=.75mm, colframe=quarto-callout-note-color-frame, left=2mm, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, rightrule=.15mm, titlerule=0mm, toprule=.15mm, coltitle=black, opacityback=0, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Advertencia}, opacitybacktitle=0.6, breakable, bottomtitle=1mm, toptitle=1mm, leftrule=.75mm, colframe=quarto-callout-warning-color-frame, left=2mm, colbacktitle=quarto-callout-warning-color!10!white, arc=.35mm, rightrule=.15mm, titlerule=0mm, toprule=.15mm, coltitle=black, opacityback=0, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip}, opacitybacktitle=0.6, breakable, bottomtitle=1mm, toptitle=1mm, leftrule=.75mm, colframe=quarto-callout-tip-color-frame, left=2mm, colbacktitle=quarto-callout-tip-color!10!white, arc=.35mm, rightrule=.15mm, titlerule=0mm, toprule=.15mm, coltitle=black, opacityback=0, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Demostración}, opacitybacktitle=0.6, breakable, bottomtitle=1mm, toptitle=1mm, leftrule=.75mm, colframe=quarto-callout-note-color-frame, left=2mm, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, rightrule=.15mm, titlerule=0mm, toprule=.15mm, coltitle=black, opacityback=0, bottomrule=.15mm]
...
\hypertarget{distribuciuxf3n-de-frecuencias-bidimensional}{%
...
\hypertarget{modelos-de-regresiuxf3n-simple}{%
...
\hypertarget{residuos-o-errores-predictivos}{%
...
\hypertarget{ajuste-de-muxednimos-cuadrados}{%
...
\hypertarget{coeficiente-de-correlaciuxf3n-lineal}{%
...
\hypertarget{distintos-grados-de-correlaciuxf3n}{%
...
\hypertarget{fiabilidad-de-las-predicciones-de-un-modelo-de-regresiuxf3n}{%
...
\hypertarget{transformaciuxf3n-de-modelos-de-regresiuxf3n-no-lineales}{%
...
\hypertarget{relaciuxf3n-exponencial}{%
...
{\centering \includegraphics[width=6.25in,height=\textheight]{img/regresion/evolucion_log_bacterias.pdf}
...
{\centering \includegraphics[width=6.25in,height=\textheight]{img/regresion/regresion_exponencial_bacterias.pdf}
...
\hypertarget{riesgos-de-la-regresiuxf3n}{%
\section{Riesgos de la regresión}\label{riesgos-de-la-regresiuxf3n}}

\hypertarget{la-falta-de-ajuste-no-significa-independencia}{%
...
\includegraphics[width=5.20833in,height=\textheight]{img/regresion/regresion_lineal_relacion_cuadratica.pdf}

}

\caption{Modelo de regresión lineal en una relación cuadrática.}
...
\includegraphics[width=5.20833in,height=\textheight]{img/regresion/regresion_cuadratica.pdf}

}

\caption{Modelo de regresión cuadrático en una relación cuadrática.}
...
\hypertarget{datos-atuxedpicos-en-regresiuxf3n}{%
...
{\centering \includegraphics[width=6.25in,height=\textheight]{img/regresion/diagrama_dispersion_con_datos_atipicos.pdf}
...
\includegraphics[width=5.20833in,height=\textheight]{img/regresion/regresion_lineal_con_datos_atipicos.pdf}

}

\caption{Modelo de regresión lineal con datos atípicos.}
...
\includegraphics[width=5.20833in,height=\textheight]{img/regresion/regresion_lineal_sin_datos_atipicos.pdf}

}

\caption{Modelo de regresión lineal sin datos atípicos.}
...
{\centering \includegraphics[width=6.25in,height=\textheight]{img/regresion/paradoja_simpson_1.pdf}
...
{\centering \includegraphics[width=6.25in,height=\textheight]{img/regresion/paradoja_simpson_2.pdf}
...
\hypertarget{hipuxf3tesis-estaduxedstica-y-tipos-de-contrastes}{%
...
{\centering \includegraphics[width=7.29167in,height=\textheight]{index_files/mediabag/img/contrastes/regiones_bilateral.pdf}
...
{\centering \includegraphics[width=7.29167in,height=\textheight]{index_files/mediabag/img/contrastes/regiones_contraste_proporcion_hombres.pdf}
...
{\centering \includegraphics[width=1\textwidth,height=\textheight]{index_files/mediabag/img/contrastes/regiones_bilateral_normal.pdf}
...
{\centering \includegraphics[width=1\textwidth,height=\textheight]{index_files/mediabag/img/contrastes/regiones_unilateral_mayor_normal.pdf}
...
{\centering \includegraphics[width=7.29167in,height=\textheight]{index_files/mediabag/img/contrastes/regiones_contraste_proporcion_hombres_2.pdf}
...
{\centering \includegraphics[width=0.8\textwidth,height=\textheight]{index_files/mediabag/img/contrastes/riesgo_beta_tamaño_efecto_pequeño.pdf}
...
{\centering \includegraphics[width=0.8\textwidth,height=\textheight]{index_files/mediabag/img/contrastes/riesgo_beta_tamaño_efecto_grande.pdf}
...
{\centering \includegraphics[width=0.8\textwidth,height=\textheight]{index_files/mediabag/img/contrastes/relacion_riesgos_alpha_pequeño.pdf}
...
{\centering \includegraphics[width=0.8\textwidth,height=\textheight]{index_files/mediabag/img/contrastes/relacion_riesgos_alpha_grande.pdf}
...
{\centering \includegraphics[width=0.8\textwidth,height=\textheight]{index_files/mediabag/img/contrastes/relacion_riesgos_tamaño_muestral_pequeño.pdf}
...
{\centering \includegraphics[width=0.8\textwidth,height=\textheight]{index_files/mediabag/img/contrastes/relacion_riesgos_tamaño_muestral_grande.pdf}
...
{\centering \includegraphics[width=0.8\textwidth,height=\textheight]{index_files/mediabag/img/contrastes/potencia.pdf}
...
\hypertarget{determinaciuxf3n-del-tamauxf1o-muestral-en-un-contraste-para-la-media}{%
...
\hypertarget{contraste-para-proporciuxf3n-de-una-poblaciuxf3n}{%
...
\hypertarget{contraste-de-comparaciuxf3n-de-medias-de-dos-poblaciones-normales-con-varianzas-desconocidas}{%
\section{Contraste de comparación de medias de dos poblaciones normales
con varianzas
