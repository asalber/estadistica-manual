...
\end{tabular}
\end{flushleft}
\end{titlepage}\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[borderline west={3pt}{0pt}{shadecolor}, breakable, frame hidden, interior hidden, boxrule=0pt, enhanced, sharp corners]}{\end{tcolorbox}}\fi
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, arc=.35mm, rightrule=.15mm, colframe=quarto-callout-important-color-frame, breakable, colbacktitle=quarto-callout-important-color!10!white, toptitle=1mm, bottomrule=.15mm, opacitybacktitle=0.6, colback=white, leftrule=.75mm, bottomtitle=1mm, coltitle=black, titlerule=0mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Importante}, toprule=.15mm, left=2mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, arc=.35mm, rightrule=.15mm, colframe=quarto-callout-warning-color-frame, breakable, colbacktitle=quarto-callout-warning-color!10!white, toptitle=1mm, bottomrule=.15mm, opacitybacktitle=0.6, colback=white, leftrule=.75mm, bottomtitle=1mm, coltitle=black, titlerule=0mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Advertencia}, toprule=.15mm, left=2mm]
...
\begin{example}[Datos
agrupados]\protect\hypertarget{exm-coeficiente-apuntamiento}{}\label{exm-coeficiente-apuntamiento}

Utilizando la tabla de frecuencias de la muestra de estaturas y
añadiendo una nueva columna con las desviaciones de la media
\(\bar x = 174.67\) cm a la cuarta, se tiene
...
\addcontentsline{toc}{subsection}{Distribuciones no normales}
...
\addcontentsline{toc}{subsubsection}{Distribución asimétrica a la
derecha no normal}
...
\addcontentsline{toc}{subsubsection}{Distribución bimodal no normal}
...
\addcontentsline{toc}{section}{Transformaciones de variables}

\markright{Transformaciones de variables}
...
\addcontentsline{toc}{subsection}{Transformaciones lineales}
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, arc=.35mm, rightrule=.15mm, colframe=quarto-callout-note-color-frame, breakable, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, bottomrule=.15mm, opacitybacktitle=0.6, colback=white, leftrule=.75mm, bottomtitle=1mm, coltitle=black, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Demostración}, toprule=.15mm, left=2mm]
...
\addcontentsline{toc}{subsection}{Transformación de tipificación y
...
\addcontentsline{toc}{subsubsection}{Transformaciones no lineales}
...
\addcontentsline{toc}{subsection}{Variables clasificadoras o factores}
...
\addcontentsline{toc}{chapter}{Estimación de parámetros poblacionales}

\markboth{Estimación de parámetros poblacionales}{Estimación de
parámetros poblacionales}

\hypertarget{estimaciuxf3n-de-paruxe1metros}{%
\section*{Estimación de
Parámetros}\label{estimaciuxf3n-de-paruxe1metros}}
\addcontentsline{toc}{section}{Estimación de Parámetros}

\markright{Estimación de Parámetros}
...
\addcontentsline{toc}{section}{Distribuciones muestrales}

\markright{Distribuciones muestrales}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{index_files/mediabag/img/estimacion/diagrama-barras-distribucion-poblacion.pdf}

\begin{figure}

{\centering \includegraphics[width=0.8\textwidth,height=\textheight]{index_files/mediabag/img/estimacion/diagrama-barras-distribucion-media.pdf}
...
\includegraphics{index_files/mediabag/img/estimacion/diagrama-barras-distribucion-poblacion.pdf}
...
\includegraphics{index_files/mediabag/img/estimacion/diagrama-barras-distribucion-media.pdf}
...
{\centering \includegraphics{img/estimacion/estimador-estimacion.pdf}
...
\color{red}{confianza} y no de probabilidad.
