...
\end{tabular}
\end{flushleft}
\end{titlepage}\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[enhanced, interior hidden, borderline west={3pt}{0pt}{shadecolor}, frame hidden, sharp corners, breakable, boxrule=0pt]}{\end{tcolorbox}}\fi
...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, toptitle=1mm, opacityback=0, colbacktitle=quarto-callout-important-color!10!white, colframe=quarto-callout-important-color-frame, leftrule=.75mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Importante}, colback=white, titlerule=0mm, opacitybacktitle=0.6, breakable, bottomtitle=1mm, left=2mm, rightrule=.15mm, coltitle=black, arc=.35mm, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, toptitle=1mm, opacityback=0, colbacktitle=quarto-callout-warning-color!10!white, colframe=quarto-callout-warning-color-frame, leftrule=.75mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Advertencia}, colback=white, titlerule=0mm, opacitybacktitle=0.6, breakable, bottomtitle=1mm, left=2mm, rightrule=.15mm, coltitle=black, arc=.35mm, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, toptitle=1mm, opacityback=0, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, leftrule=.75mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Demostración}, colback=white, titlerule=0mm, opacitybacktitle=0.6, breakable, bottomtitle=1mm, left=2mm, rightrule=.15mm, coltitle=black, arc=.35mm, bottomrule=.15mm]
