...
:::{#exm-}
En un estudio para ver si existe relación entre el sexo y el hábito de fumar se ha tomado una muestra de 100 personas. La tabla de contingencia resultante es
...
:::{#def-}
## Coeficiente de contingencia
Dada una muestra de tamaño $n$ en la que se han medido dos atributos $X$ e $Y$, se define el _coeficiente de contingencia_ como
