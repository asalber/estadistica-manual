...
:::{#def-}
## Coeficiente de correlación de Spearman**. Dada una muestra de $n$ individuos en los que se han medido dos atributos ordinales $X$ e $Y$, el coeficiente de correlación de Spearman se define como
...
:::{#exm-**. Una muestra de 5 alumnos realizaron dos tareas diferentes $X$ e $Y$, y se ordenaron de acuerdo a la destreza que manifestaron en cada tarea:
...
:::{#exm-**. En un estudio para ver si existe relación entre el sexo y el hábito de fumar se ha tomado una muestra de 100 personas. La tabla de contingencia resultante es
...
:::{#def-}
## Coeficiente Chi-cuadrado $\chi^2$**. Dada una muestra de tamaño $n$ en la que se han medido dos atributos $X$ e $Y$, se define el coeficiente $\chi^2$ como
...
:::{#exm-**. Siguiendo con el ejemplo anterior, a partir de la tabla de contingencia
...
:::{#def-}
## Coeficiente de contingencia**. Dada una muestra de tamaño $n$ en la que se han medido dos atributos $X$ e $Y$, se define el _coeficiente de contingencia_ como
...
:::{#exm-**. En el ejemplo anterior el coeficiente de contingencia vale
