...
:::{#def-estadistica}
## Estadística
La _estadística_ es una rama de las matemáticas que se encarga de la recogida, análisis e interpretación de datos.
:::
...
![Propósito de la Estadística](img/introduccion/proposito_estadistica.svg)
:::

::: {.content-visible unless-format="html"}
![Propósito de la Estadística](img/introduccion/proposito_estadistica.png)
:::
...
:::{#def-poblacion}
## Población
Una _población_ es un conjunto de elementos definido por una o más características que tienen todos los elementos, y sólo ellos. Cada elemento de la población se llama _individuo_.
:::

:::{#def-tamaño-poblacional}
## Tamaño poblacional
El número de individuos de una población se conoce como _tamaño poblacional_ y se representa como $N$.
:::

:::{#exm-tamaño-poblacional}
En unas elecciones generales a la presidencia del gobierno, la población serían todos los individuos del estado con derecho a voto. En el estudio de una enfermedad, la población sería todas las personas que tienen la enfermedad. Y en un proceso de control de calidad en la fabricación de un fármaco, la población estaría formada por todos los fármacos que se producen en la fábrica.
:::
...
:::{#def-muestra}
## Muestra
Una _muestra_ es un subconjunto de la población.
:::

:::{#def-tamaño-muestral}
## Tamaño muestral
Al número de individuos que componen la muestra se le llama _tamaño muestral_ y se representa por $n$.
:::
...
:::{#exm-tamaño-muestral-suficiente}
Para entender a qué nos referimos cuando hablamos de un tamaño muestral suficiente para comprender lo que ocurre en la población, podemos utilizar el siguiente símil en que se trata de comprender el motivo que representa una fotografía.
...
![Muestra pequeña de píxeles de una foto.](img/introduccion/muestra_molinos1.jpg)
...
![Muestra mayor de píxeles de una foto.](img/introduccion/muestra_molinos2.jpg)

_¡Con una muestra mayor es posible desvelar el motivo de la foto!_

Y aquí está la población completa.

![Población de píxeles de una foto.](img/introduccion/muestra_molinos3.jpg)
...
::: {.content-visible when-format="html"}
![Tipos de razonamiento.](img/introduccion/tipos_razonamiento.svg)
:::

::: {.content-visible unless-format="html"}
![Tipos de razonamiento.](img/introduccion/tipos_razonamiento.png)
:::
...
:::{#def-muestreo}
## Muestreo
El proceso de selección de los elementos que compondrán una muestra se conoce como _muestreo_.
:::
...
:::{#def-variable-estadistica}
## Variable estadística
Una _variable estadística_ es una propiedad o característica medida en los individuos de la población.
...
::: {.content-visible unless-format="html"}
![Variables estadísticas.](img/introduccion/variables_estadisticas.png)
:::
...
::: {.content-visible when-format="html"}
![Tipos de variables estadísticas.](img/introduccion/tipos_variables.svg)
:::

::: {.content-visible unless-format="html"}
![Tipos de variables estadísticas.](img/introduccion/tipos_variables.png)
:::
...
::: {.content-visible when-format="html"}
![Cantidad de información de los tipos de variables estadísticas.](img/introduccion/informacion_variables.svg)
:::

::: {.content-visible unless-format="html"}
![Cantidad de información de los tipos de variables estadísticas.](img/introduccion/informacion_variables.png)
:::
...
:::{#exm-variables-dependientes-independientes}
En un estudio sobre el rendimiento de los alumnos de un curso, la inteligencia de los alumnos y el número de horas de estudio diarias serían variables independientes y la nota del curso sería una variable dependiente.
:::
...
:::{#exm-estudios-experimentales}
En un estudio sobre el rendimiento de los estudiantes en un test, el profesor manipula la metodología de estudio para crear dos o más grupos con metodologías de estudio distintas.
:::
...
:::{#exm-tabla-datos}
La siguiente tabla contiene información de las variables Nombre, Edad, Sexo, Peso y Altura de una muestra de 6 personas.
...
::: {.content-visible when-format="html"}
![El ciclo estadístico.](img/introduccion/ciclo_estadistico.svg)
:::

::: {.content-visible unless-format="html"}
![El ciclo estadístico.](img/introduccion/ciclo_estadistico.eps)
:::
